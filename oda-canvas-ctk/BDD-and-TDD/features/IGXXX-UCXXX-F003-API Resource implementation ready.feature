Feature: IGXXX-UCXXX-F003-API Resource public URL
    ...
    Scenario: Test API Resource public URL for Core API
        ...
        Then I should see the 'productcatalogmanagement' API resource with an implementation ready status in the Kubernetes cluster
    ...
    Scenario: Test API Resource public URL for Management API
        ...
        When I install the 'productcatalog' component helm chart
        Then I should see the 'metrics' API resource with an implementation ready status in the Kubernetes cluster
    ...
    Scenario: Test API Resource public URL for Security API
        ...
        When I install the 'productcatalog' component helm chart
        Then I should see the 'partyrole' API resource with an implementation ready status in the Kubernetes cluster
