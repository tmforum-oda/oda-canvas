...
Feature: UC003-F005 Expose APIs: Upgrade component with removed API
    ...
    Background:
        Given An example package 'productcatalog-enhanced-v1beta2' with a 'productcatalogmanagement' component with '2' API in its 'coreFunction' segment
    ...
    Scenario: Upgrade component with removed API in coreFunction
        Given An example package 'productcatalog-v1beta2' with a 'productcatalogmanagement' component with '1' API in its 'coreFunction' segment
