...
import org.tmform.oda.canvas.portal.component.controller.console.dto.CreateOdaOrchestrationDto;
import org.tmform.oda.canvas.portal.component.controller.console.dto.UpdateOdaOrchestrationDto;
...
public class OrchestrationService {
    ...
    public List<GenericKubernetesResource> listOdaOrchestrationResources(Integer tenantId, String namespace, String keyword) throws BaseAppException {
        try {
            ...
            // FIXME
            //LOGGER.warn(e);
            ExceptionPublisher.publish(e, ExceptionErrorCode.ODA_LIST_ORCHESTRATION_FAILED, namespace, tenantId);
        }
    ...
    public List<Event> getOdaOrchestrationEvents(String namespace, String orchestration) throws BaseAppException {
        try {
            ...
            // FIXME
            // LOGGER.warn(e);
            ExceptionPublisher.publish(e, ExceptionErrorCode.LIST_ODA_ORCHESTRATION_EVENTS_FAILED, orchestration, namespace);
        }
        return Lists.newArrayList();
    }
    ...
    public GenericKubernetesResource checkOdaOrchestrationResourceExist(String namespace, String name) throws BaseAppException {
        ...
        try {
            ...
            //LOGGER.warn(e);
            // FIXME
            ExceptionPublisher.publish(e, ExceptionErrorCode.ODA_GET_ORCHESTRATION_FAILED, name, namespace);
        }

        if (resource != null) {
            return resource;
        }
        ExceptionPublisher.publish(ExceptionErrorCode.ODA_ORCHESTRATION_NOT_EXIST, name, namespace);
    ...
    public void createOdaOrchestration(CreateOdaOrchestrationDto createOdaOrchestrationDto) throws BaseAppException {
        ...
        try {
            ...
            //LOGGER.warn(e);
            ExceptionPublisher.publish(e, ExceptionErrorCode.ODA_CREATE_ORCHESTRATION_FAILED, createOdaOrchestrationDto.getName(), createOdaOrchestrationDto.getNamespace(), createOdaOrchestrationDto.getTenantId());
        }
    }
    ...
    public void updateOdaOrchestration(String namespace, String name, UpdateOdaOrchestrationDto updateOdaOrchestrationDto) throws BaseAppException {
        ...
        try {
            ...
            // FIXME
            //LOGGER.warn(e);
            ExceptionPublisher.publish(e, ExceptionErrorCode.ODA_UPDATE_ORCHESTRATION_FAILED, name, namespace);
        }
    }
}
