...
Given('an API resource with rate limiting enabled and a limit of {int} requests per minute', function (limit) {
  this.apiResource = {
    path: '/pc-productcatalogmanagement/tmf-api/productCatalogManagement/v4',
...
Given('an API resource with a URL template for plugins "{string}"', function (url) {
  this.apiResource = { path: '/pc-productcatalogmanagement/tmf-api/productCatalogManagement/v4', template: url };
});
