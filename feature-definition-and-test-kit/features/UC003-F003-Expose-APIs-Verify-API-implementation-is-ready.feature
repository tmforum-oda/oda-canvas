...
Feature: UC003-F003 Expose APIs: Verify API implementation is ready
    ...
    Scenario: Verify API Resource is ready for Core API
        ...
        Then I should see the 'productcatalogmanagement' API resource on the 'productcatalogmanagement' component with an implementation ready status on the Service Mesh or Gateway
    ...
    Scenario: Verify API Resource is ready for Management API
        ...
        When I install the 'productcatalog-v1beta3' package
        Then I should see the 'metrics' API resource on the 'productcatalogmanagement' component with an implementation ready status on the Service Mesh or Gateway
    ...
    Scenario: Verify API Resource is ready for Security API
        ...
        When I install the 'productcatalog-v1beta3' package
        Then I should see the 'partyrole' API resource on the 'productcatalogmanagement' component with an implementation ready status on the Service Mesh or Gateway
