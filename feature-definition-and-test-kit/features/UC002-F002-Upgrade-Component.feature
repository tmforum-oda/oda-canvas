...
Feature: UC002-F002 Upgrade Component
    ...
    Scenario Outline: Updated component with added ExposedAPI resources
        Given a baseline 'productcatalog-v1beta4' package installed as release 'pc'
        ...
        When I upgrade the 'productcatalog-enhanced-v1beta4' package as release 'pc'
    ...
    Scenario Outline: Updated component with removed ExposedAPI resources
        Given a baseline 'productcatalog-enhanced-v1beta4' package installed as release 'pc'
        ...
        When I upgrade the 'productcatalog-v1beta4' package as release 'pc'
    ...
    Scenario Outline: Updated component with updated ExposedAPI resources
        ...
        When I upgrade the 'productcatalog-updated-v1beta4' package as release 'pc'
