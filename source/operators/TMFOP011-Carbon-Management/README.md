...
The current Carbon Management Operator implementation provides carbon-aware scaling through KEDA integration. For detailed installation, configuration, and usage instructions, see:

- **[Carbon Management Operator README](./carbon-management/README.md)**
