...
class Controller {
  ...
  static collectRequestParams(request) {
    ...
    try {
      if (request.openapi && request.openapi.schema && request.openapi.schema.requestBody) {
        requestParams.body = request.body;
      }
      if(request.openapi && request.openapi.schema && request.openapi.schema.parameters) {
