...
* Specific design decisions where we assess options and make a decision are documented in the [Design Decision Log](https://github.com/tmforum-oda/oda-ca-docs/tree/master/Decision-Log/README.md).
