...
For a comprehensive introduction to ODA and the role of the Canvas in implementation and deployment, see [ODA explained: tools for implementation and deployment](https://inform.tmforum.org/features-and-opinion/oda-explained-tools-for-implementation-and-deployment). To explore available ODA Components that can be deployed on the Canvas, visit the [ODA Component Directory](https://www.tmforum.org/oda/directory).
