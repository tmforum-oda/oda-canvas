...
```
kubectl edit -n canvas cm canvas-controller-configmap
...
helm upgrade --install prodcat -n components feature-definition-and-test-kit/testData/productcatalog-v1beta3
...
```
kubectl get dependentapis -n components   prodcat-productcatalogmanagement-dapi-party -oyaml
```
