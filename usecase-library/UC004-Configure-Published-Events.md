...
![publish-event-create](./pumlFiles/publish-event-create.svg)
...
![publish-event-update-with-mopdify](./pumlFiles/publish-event-update-with-modify.svg)
...
![publish-event-update-with-add](./pumlFiles/publish-event-update-with-add.svg)
...
![publish-event-update-with-delete](./pumlFiles/publish-event-update-with-delete.svg)
...
![publish-event-delete](./pumlFiles/publish-event-delete.svg)
