...
* The Bootstrap process will also assign the Canvas `canvassystem` user to the Admin role. This user can be used for all subsequent API calls from the Canvas. The `canvassystem` user was created as part of the Canvas setup.
