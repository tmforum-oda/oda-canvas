...
shutil.copy2('../securityController/sequenceDiagrams/securitySequence-keycloak.png', './securityController/sequenceDiagrams') 
shutil.copy2('../securityController/sequenceDiagrams/securitySequence-keycloak-detailed.png', './securityController/sequenceDiagrams') 
