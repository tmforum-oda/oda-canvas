docker build --file component-IngressController-dockerfile -t tmforumodacanvas/component-controller:0.14.0 -t tmforumodacanvas/component-controller:master -t tmforumodacanvas/component-controller:latest .
...
docker build --file securityControllerAPIserver-keycloak-dockerfile -t tmforumodacanvas/security-listener:0.5.0 -t tmforumodacanvas/security-listener:latest -t tmforumodacanvas/security-listener:master .
