...
docker build --file component-IstioController-dockerfile -t tmforumodacanvas/component-istio-controller:0.2.6 .
docker push tmforumodacanvas/component-istio-controller:0.2.6
