...
docker build --file component-IstioController-dockerfile -t tmforumodacanvas/component-istio-controller:0.1.11 .
docker push tmforumodacanvas/component-istio-controller:0.1.11
