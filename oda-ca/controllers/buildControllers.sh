...
docker build --file component-IstioController-dockerfile -t tmforumodacanvas/component-istio-controller:0.2.1 .
docker push tmforumodacanvas/component-istio-controller:0.2.1
